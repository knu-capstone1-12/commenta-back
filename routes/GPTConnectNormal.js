...
var openaiNormal = new OpenAI({
    apiKey: process.env.OPENAI_API_KEY,
});
var runPromptNormal = function (UserComment) { return __awaiter(void 0, void 0, void 0, function () {
    var response, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, openaiNormal.chat.completions.create({
                        model: "gpt-3.5-turbo",
                        messages: [
                            {
                                role: "user",
...
router.post("/gptnormal", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var GPTresult;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, runPromptNormal(req.body.content)];
            case 1:
                GPTresult = _a.sent();
